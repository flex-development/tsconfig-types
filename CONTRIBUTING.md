...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/tsconfig-types
   cd tsconfig-types
   ```
...
```sh
https://github.com/flex-development/tsconfig-types/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/tsconfig-types/discussions/new?category=q-a
