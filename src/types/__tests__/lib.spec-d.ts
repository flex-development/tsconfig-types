...
describe('unit:types/Lib', () => {
  ...
  it('should extract "ES2022.Object"', () => {
    expectTypeOf<TestSubject>().extract<'ES2022.Object'>().toBeString()
  })
  ...
  it('should extract "ES2022.String"', () => {
    expectTypeOf<TestSubject>().extract<'ES2022.String'>().toBeString()
  })
  ...
  it('should extract "ES2023.Array"', () => {
    expectTypeOf<TestSubject>().extract<'ES2023.Array'>().toBeString()
  })

  it('should extract "ES2023.Full"', () => {
    expectTypeOf<TestSubject>().extract<'ES2023.Full'>().toBeString()
  })

  it('should extract "ES2023"', () => {
    expectTypeOf<TestSubject>().extract<'ES2023'>().toBeString()
  })
